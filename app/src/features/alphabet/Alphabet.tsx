        ...
        {a.letters.map(l => (
          <div key={l.letter} className="card">
            <div className="row between">
              ...
              <button className="audiobtn small" onClick={() => playAudio(`/${l.audio_name}`)} aria-label={`${t.letter_name} ${l.name}`}>🔊</button>
            </div>
            <div className="small muted">{t.letter_name}: <b>{l.name}</b> · <span className="mono">[{l.ipa}]</span></div>
